...
const questions: Question[] = [
  ...
  {
    id: 3,
    text: "3. Do you use a password manager to help you keep track of your passwords?",
  },
  {
    id: 4,
    ...
    <div className="container mx-auto">
      ...
      {score > 0 && (
        <div className="mt-4">
          ...
          <p className="mt-2">
            {getMessage()}{" "}
            <Link href="https://dot.gov.in/banner/cyber-dost"><span className="bg-gray-800 p-1 rounded-3xl text-white">Click here</span>  to learn about Cyber Security tips</Link>
          </p>
        </div>
      )}
    </div>
